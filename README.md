This projects aim to build a solver for the board game from A Lif of Logic. The purpose of the project is to implement and visualize the backtracking algorithm.
